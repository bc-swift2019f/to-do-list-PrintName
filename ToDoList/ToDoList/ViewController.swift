...
class ViewController: UIViewController {
    ...
    var toDoNotesArray = ["I should be certain to do all the exercises at the end of the chapters before the exam.", "Take my ideas to the school's venture competition and win the big check.", "Focus apps on empowerment for all, with an extra bonus for users who are kind."]
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath){
        ...
        toDoArray.insert(noteToMove, at: destinationIndexPath.row)
    }
